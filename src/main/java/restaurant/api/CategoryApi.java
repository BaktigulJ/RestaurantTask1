...
public class CategoryApi {
    ...
    @Secured({"ADMIN", "CHEF"})
    @PostMapping
    public SimpleResponse saveCategory(@RequestBody @Valid CatSaveRequest catSaveRequest,
                                  Principal principal) {
    ...
    @Secured({"ADMIN", "CHEF"})
    @PutMapping("/{catId}")
    public SimpleResponse updateCategory(@PathVariable Long catId,
    ...
    @Secured("ADMIN")
    @DeleteMapping("/{catId}")
    public SimpleResponse deleteCategory(@PathVariable Long catId, Principal principal) {
